...
?>
<fieldset class="hkform-horizontal edit_form">
<?php
...
<!-- <div class="hkform-group control-group hikashop_address_required_info_line">
			...
			<div class="action">
				<div class="hkc-sm-4"></div>
				<div class="hkc-sm-8" style="text-align: center;">
				<button onclick="return window.checkout.submitAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikashop_checkout_address_ok_button btn btn-primary">Save</button>
				<button onclick="return window.checkout.refreshAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikashop_checkout_address_cancel_button btn btn-default">Cancer</button>
				</div>
			</div>
...
?>
				...
				<div class="hika_edit">
						<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$cart->cart_billing_address_id; ?>);" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i><span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
						<a href="<?php echo hikashop_completeLink($delete_url);?>" onclick="return window.checkout.deleteAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$cart->cart_billing_address_id; ?>);" class="btn btn-primary"><i class="fa fa-trash" aria-hidden="true"></i><span><?php echo JText::_('HIKA_DELETE'); ?></span></a>
					</div>
</div>
				<div class="">
...
<div class="hika_edit">
						<a href="<?php echo hikashop_completeLink($update_url);?>" onclick="return window.checkout.editAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$shipping_address_id; ?>);" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i><span><?php echo JText::_('HIKA_EDIT'); ?></span></a>
						<a href="<?php echo hikashop_completeLink($delete_url);?>" onclick="return window.checkout.deleteAddress(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>,<?php echo (int)$shipping_address_id; ?>);" class="btn btn-primary"><i class="fa fa-trash" aria-hidden="true"></i><span><?php echo JText::_('HIKA_DELETE'); ?></span></a>
					</div>
</div>
				<div class="">
