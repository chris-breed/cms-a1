...
?>
	...
	<div class="input-append">
		...
		<button type="submit" onclick="return window.checkout.submitCoupon(<?php echo $this->step.','.$this->module_position; ?>);" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikabtn_checkout_coupon_add btn btn-primary"><?php
			echo JText::_('ADD');
		?></button>
		</div>
<?php
