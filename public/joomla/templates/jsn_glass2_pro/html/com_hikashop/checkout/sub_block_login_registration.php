...
?><fieldset class="hkform-horizontal form-inline">
<?php
...
?>
	...
	<div class="hkform-group control-group button-action">
		<div class="<?php echo $labelcolumnclass;?> hkcontrol-label"></div>
		<div class="<?php echo $inputcolumnclass;?> action">
			<button type="submit" onclick="window.checkout.submitLogin(<?php echo $this->step; ?>,<?php echo $this->module_position; ?>, 'register'); return false;" class="<?php echo $this->config->get('css_button','hikabtn'); ?> hikabtn_checkout_login_register btn btn-default" id="hikashop_register_form_button"><i class="fa fa-pencil" aria-hidden="true"></i> <?php
