...
?>
	...
	<div class="buttons_right">
		<button type="submit" class="<?php echo $this->config->get('css_button','hikabtn'); ?> btn-primary" onclick="this.form.submit(); this.disabled=true; window.Oby.addClass(this, 'next_button_disabled'); return false;"><?php
