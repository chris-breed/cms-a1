...
if(!empty($this->rows)) {
	...
	?>
	<div class="hikashop_subcategories hikashop_category_listing_div" <?php echo $attributes; ?>>
	<?php
...
?>
			<div class="hkc-sm-6 hkc-md-<?php echo (int)$span; ?> hikashop_category hikashop_category_column_<?php echo $current_column; ?> hikashop_category_row_<?php echo $current_row.$class; ?>">
