...
?>
<div class="hikashop_products hikashop_product_list_div"<?php echo $attributes; ?>>
<?php
}
...
?>
		<div class="hkc-md-<?php echo (int)$span; ?> hikashop_product hikashop_product_column_<?php echo $current_column; ?> hkc-sm-6 hikashop_product_row_<?php echo $current_row; ?>">
