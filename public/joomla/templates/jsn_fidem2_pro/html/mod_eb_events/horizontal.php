    ...
    <div class="eb-event-columns">
            ...
            <div class="up-event-item">
				...
				?>
					<div class="eb-event-category clearfix">
						<span><i class="fa fa-folder-open"></i><?php echo $event->categories ; ?></span>
					</div>
				<?php
				}
				?>
	            ...
	            ?>
					<a class="<?php echo $btnClass; ?> readmore" href="<?php echo $detailUrl; ?>">
        ...
        <?php
		    ...
		    ?>
		        ...
		        <div class="eb-event-columns clearfix">
		    <?php
	        }
        }
        ?>
