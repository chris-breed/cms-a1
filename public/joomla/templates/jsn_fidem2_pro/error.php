                    ...
                    <div class="table">
                        <div class="table-cell">
                            ...
                            <div class="content-inner">
                                <img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/church.png" />
                                <h4 class="jsn-error-text">Oops ! <?php echo htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8');?> at this location </br>Maybe try a search?</h4>
