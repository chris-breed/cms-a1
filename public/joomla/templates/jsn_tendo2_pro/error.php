                ...
                <div id="content" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <!-- Begin Content -->
                        ...
                        <div class="content-inner">
                            <h4 class="jsn-error-text">Oops,</h4>
                            <p class="jsn-error-name"><?php echo htmlspecialchars($this->error->getMessage(), ENT_QUOTES, 'UTF-8');?></p>
                            <p class="jsn-error-text-desc">Error 404 page not found</p>
                            <div class="goto-home"><a href="<?php echo JUri::base();?>">Go To The Home Page</a></div>
                        </div>
                    <!-- End Content -->
                </div>
            </div>
